...
%---------------------------------------------------------------------------------------------------------- 
% R_MainFun : Fixed QC studies the effect of changing r_set on time
r_set = [30 50 80 120];        % r_set: # of iterations(CSR_IT,CSR_RLS) and low-rank(CSR_NI,CSR_Our)   
% r_set =[5,10,15,20];             
% QC = 100;                       % QC: # of query nodes
 QC = 300;                        
% Block_S = QC/100;               % ED
Block_S = QC/5;                   % (FB,P2P,WN,YT,WT)
R_MainFun(a, c, r_set, QC, Block_S);

%-----------------------------------------------------------------------------------------------------------
%  Q_MainFun : Fixed r_set studies the effect of changing QC on time
% r_set = 5;
% r_set = 50;
%  QC = [100 300 500 700];
% Block_S = QC/100;               
% Block_S = QC/5;                  
% Q_MainFun(a, c, r_set, QC, Block_S);
